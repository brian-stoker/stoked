...
export default {
  tasks: [{
    inputs: [
      {
        events: {
          ...
          processResults: ($response: any) => {
            return $response.filter((event: any) => {
    ...
    prompt: `You are an experienced software engineer, drummer, artist, and entrepreneur. 
Given the github events and the activity watch data from your computer you will create a daily public post for your personal website documenting your activities for the day. The post should be funny, engaging, yet informative. 
