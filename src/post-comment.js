...
var postComment = function (owner, repo, issue_number, commentBody) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_1;
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, postComment("stoked-ui", "sui", 57, "This is a test comment from the updated script.")];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
                console.error("Failed to post comment:", error_2);
                process.exit(1);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
